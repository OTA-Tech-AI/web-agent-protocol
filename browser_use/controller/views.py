...
class SelectOptionBySelectorAction(BaseModel):
    css_selector: str               # e.g. "#searchDropdownBox"
    value: str | None = None        # preferred (unique)
    label: str | None = None        # visible text fallback
